...
<head>
  ...
  <title>Macroziontechsystem.com</title>
  ...
  <div class="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <a class="navbar-brand logo');?>" href="index.html">
        ...
        <img class="logo-white" src="<?php echo  base_url('/assets/images/logo-white.png" alt="logo');?>"/>
      </a>
      <!-- /logo -->
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 mt-20">
        <h2>macrozion<br> and technology</h2>
      ...
      <div class="col-md-6">
        <img class="img-fluid" src="<?php echo  base_url('/assets/images/company/company-image.jpg');?>" alt="">
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        ...
        <img src="<?php echo  base_url('/assets/images/company/company-image-2.jpg');?>" alt="" class="img-fluid mt-30">
      </div>
      <div class="col-md-6">
        <h3>Our Vision</h3>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facere in suscipit voluptatum totam dolores assumenda vel, quia earum voluptatem blanditiis vero accusantium saepe aliquid nulla nemo accusamus, culpa inventore! Culpa nemo aspernatur tenetur, at quam aliquid reprehenderit obcaecati dicta illum mollitia, perferendis hic, beatae voluptates? Ex labore, obcaecati harum nam.</p>
        <img src="<?php echo  base_url('/assets/images/company/company-image-3.jpg');?>" alt="" class="img-fluid mt-30">
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="company-gallery">
          <img src="<?php echo  base_url('/assets/images/company/gallery-1.jpg');?>" alt="">
          <img src="<?php echo  base_url('/assets/images/company/gallery-2.jpg');?>" alt="">
          <img src="<?php echo  base_url('/assets/images/company/gallery-3.jpg');?>" alt="">
          <img src="<?php echo  base_url('/assets/images/company/gallery-4.jpg');?>" alt="">
          <img src="<?php echo  base_url('/assets/images/company/gallery-5.jpg');?>" alt="">
          <img src="<?php echo  base_url('/assets/images/company/gallery-5.jpg');?>" alt="">
          <img src="<?php echo  base_url('/assets/images/company/gallery-1.jpg');?>" alt="">
          <img src="<?php echo  base_url('/assets/images/company/gallery-2.jpg');?>" alt="">
          <img src="<?php echo  base_url('/assets/images/company/gallery-3.jpg');?>" alt="">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-6 ">
        <div class="team-member text-center">
          <div class="member-photo">
            <!-- member photo -->
            <img class="img-fluid" src="<?php echo  base_url('/assets/images/team/member-1.jpg');?>" alt="Meghna">
            <!-- /member photo -->
      ...
      <div class="col-md-4 col-sm-6 ">
        <div class="team-member text-center">
          <div class="member-photo">
            <!-- member photo -->
            <img class="img-fluid" src="<?php echo  base_url('/assets/images/team/member-2.jpg');?>" alt="Meghna">
            <!-- /member photo -->
      ...
      <div class="col-md-4 col-sm-6 ">
        <div class="team-member text-center">
          <div class="member-photo">
            <!-- member photo -->
            <img class="img-fluid" src="<?php echo  base_url('/assets/images/team/member-3.jpg');?>" alt="Meghna">
            <!-- /member photo -->
...
<footer id="footer" class="bg-one">
  ...
  <div class="footer-bottom">
    ...
    <!-- Parallax -->
    <script src="<?php echo  base_url('/assets/plugins/parallax/jquery.parallax-1.1.3.js');?>"></script>
    <!-- lightbox -->
    <script src="<?php echo  base_url('/assets/plugins/lightbox2/dist/js/lightbox.min.js');?>"></script>
    <!-- Owl Carousel -->
    ...
    <!-- Smooth Scroll js -->
    <script src="<?php echo  base_url('/assets/plugins/smooth-scroll/smooth-scroll.min.js');?>"></script>
